...
) ENGINE=InnoDB AUTO_INCREMENT=28345489 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bookings` (
  ...
  `binary_mask` decimal(40,0) DEFAULT '0',
  ...
  KEY `index_bookings_on_start_end_time` (`start_time`,`end_time`),
  KEY `index_bookings_on_listing_id_and_start_time` (`listing_id`,`start_time`)
) ENGINE=InnoDB AUTO_INCREMENT=3780 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `browser_fingerprint_usages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `browser_fingerprint_usages` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `browser_fingerprint_id` bigint DEFAULT NULL,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_browser_fingerprint_usages_on_browser_fingerprint_id` (`browser_fingerprint_id`),
  CONSTRAINT `fk_rails_442d551b94` FOREIGN KEY (`browser_fingerprint_id`) REFERENCES `browser_fingerprints` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=282915 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `browser_fingerprints`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `browser_fingerprints` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=160614 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `categories` (
  ...
  `quick_filter` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=311954 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2333750 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=723395 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `communities` (
  ...
  `affiliate_percent` float DEFAULT '10',
  `membership_extend` int DEFAULT '3',
  `hotel_percent_platform` float DEFAULT '10',
  `hotel_percent_user` float DEFAULT '5',
  `referral_discount` int DEFAULT '0',
  `hotel_percent_guest` float DEFAULT '5',
  `platform_percent_guest` float DEFAULT '10',
  `self_service_price_cents` int DEFAULT NULL,
  `premium_for_everyone` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_communities_on_uuid` (`uuid`),
  KEY `index_communities_on_domain` (`domain`),
  KEY `index_communities_on_ident` (`ident`)
) ENGINE=InnoDB AUTO_INCREMENT=11723 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `community_customizations` (
  ...
  `welcome_member_email_content` mediumtext,
  PRIMARY KEY (`id`),
  KEY `index_community_customizations_on_community_id` (`community_id`)
) ENGINE=InnoDB AUTO_INCREMENT=15907 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=739747 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=293060 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=318728 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=42669 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3546051 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=422751 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=272534 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3665840 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=34315 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `documents` (
  ...
  `document_role` varchar(255) DEFAULT NULL,
  `doc_type` varchar(255) DEFAULT NULL,
  `docusign_id` varchar(255) DEFAULT NULL,
  `document_file_name` varchar(255) DEFAULT NULL,
  `document_content_type` varchar(255) DEFAULT NULL,
  `document_file_size` int DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `docusign_authorizations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `docusign_authorizations` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `community_id` int DEFAULT NULL,
  `person_id` varchar(22) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=776930 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `event_sync_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `fareharbor_companies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fareharbor_companies` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `person_id` varchar(22) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `active` tinyint(1) DEFAULT NULL,
  `new_listings_open` tinyint(1) DEFAULT NULL,
  `category_id` bigint DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shortname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `affiliated_since` datetime DEFAULT NULL,
  ...
  `booking_notes` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `address_province` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `billing_address_province` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `primary_location_id` bigint DEFAULT NULL,
  `primary_location_heading` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `facebook_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `instagram_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tripadvisor_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `twitter_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `yelp_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `youtube_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pinterest_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `health_and_safety_policy` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `open_hours` json DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_fareharbor_companies_on_person_id` (`person_id`),
  KEY `index_fareharbor_companies_on_category_id` (`category_id`),
  KEY `index_fareharbor_companies_on_primary_location_id` (`primary_location_id`),
  KEY `index_fareharbor_companies_on_shortname` (`shortname`)
) ENGINE=InnoDB AUTO_INCREMENT=3158 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `fareharbor_failures`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fareharbor_failures` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `fareharbor_shortname` varchar(255) DEFAULT NULL,
  `fareharbor_item` varchar(255) DEFAULT NULL,
  `exception` text,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `backtrace` text,
...
) ENGINE=InnoDB AUTO_INCREMENT=57538 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `feedbacks` (
  ...
  `community_id` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=61782 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14710 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `harmony_bookables`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `harmony_bookables` (
  ...
  `unit_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'day',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `harmony_bookings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `harmony_bookings` (
  ...
  `status` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'initial',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `harmony_exceptions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `harmony_exceptions` (
  ...
  `bookable_id` binary(16) NOT NULL,
  `seats_override` int DEFAULT NULL,
  `start` datetime NOT NULL,
  `end` datetime NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `harmony_plans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `harmony_plans` (
  ...
  `bookable_id` binary(16) NOT NULL,
  `seats` int NOT NULL DEFAULT '1',
  `plan_mode` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'available',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=213133 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `listing_add_ons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `listing_add_ons` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_listing_add_ons_on_listing_id` (`listing_id`)
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `listing_hide_from_people`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `listing_hide_from_people` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `listing_id` bigint DEFAULT NULL,
  `person_id` varchar(22) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_listing_hide_from_people_on_listing_id` (`listing_id`),
  KEY `index_listing_hide_from_people_on_person_id` (`person_id`)
...
CREATE TABLE `listing_images` (
  ...
  `fareharbor_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_listing_images_on_listing_id` (`listing_id`),
  KEY `index_listing_images_on_fareharbor_id` (`fareharbor_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1448294 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `listing_service_fees`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `listing_service_fees` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `person_id` varchar(22) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_listing_service_fees_on_person_id` (`person_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `listing_service_fees_listings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `listing_service_fees_listings` (
  `listing_id` bigint NOT NULL,
  `listing_service_fee_id` bigint NOT NULL,
  KEY `index_listing_service_fees_listings_on_listing_id` (`listing_id`),
  KEY `index_listing_service_fees_listings_on_listing_service_fee_id` (`listing_service_fee_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=101776 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `listing_show_for_people`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `listing_show_for_people` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `listing_id` bigint DEFAULT NULL,
  `person_id` varchar(22) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_listing_show_for_people_on_listing_id` (`listing_id`),
  KEY `index_listing_show_for_people_on_person_id` (`person_id`)
) ENGINE=InnoDB AUTO_INCREMENT=379 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `listing_taxes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `listing_taxes` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `person_id` varchar(22) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `percent` varchar(255) DEFAULT NULL,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_listing_taxes_on_person_id` (`person_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `listing_taxes_listings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `listing_taxes_listings` (
  `listing_id` bigint NOT NULL,
  `listing_tax_id` bigint NOT NULL,
  KEY `index_listing_taxes_listings_on_listing_id` (`listing_id`),
  KEY `index_listing_taxes_listings_on_listing_tax_id` (`listing_tax_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=190797 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `listing_working_time_slots` (
  ...
  `start_time` datetime DEFAULT NULL,
  `end_time` datetime DEFAULT NULL,
  `calendar` tinyint(1) DEFAULT '0',
  `binary_mask` decimal(40,0) DEFAULT '0',
  `booked_mask` decimal(40,0) DEFAULT '0',
  `available_mask` decimal(40,0) DEFAULT '0',
  `max_capacity` int DEFAULT '0',
  `per_day` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `index_listing_working_time_slots_on_listing_id` (`listing_id`),
  KEY `index_working_time_slots_on_start_end_time` (`calendar`,`start_time`,`end_time`,`listing_id`),
  KEY `index_listing_and_time` (`listing_id`,`start_time`,`end_time`)
) ENGINE=InnoDB AUTO_INCREMENT=48236 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `listings` (
  ...
  `community_id` int NOT NULL,
  `author_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_old` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `listing_type_old` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `share_type_old` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `privacy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'private',
  `comments_count` int DEFAULT '0',
  `subcategory_old` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `old_category_id` int DEFAULT NULL,
  `category_id` int DEFAULT NULL,
  `share_type_id` int DEFAULT NULL,
  `listing_shape_id` int DEFAULT NULL,
  `transaction_process_id` int DEFAULT NULL,
  `shape_name_tr_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `action_button_tr_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `price_cents` int DEFAULT NULL,
  `currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quantity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unit_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quantity_selector` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unit_tr_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unit_selector_tr_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deleted` tinyint(1) DEFAULT '0',
  ...
  `availability` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'booking',
  `per_hour_ready` tinyint(1) DEFAULT '0',
  `featured` tinyint(1) DEFAULT '0',
  `call_for_price` tinyint(1) DEFAULT '0',
  `booking_mode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'hour',
  `min_units` float DEFAULT '1',
  `deposit_cents` int DEFAULT NULL,
  `document_id` int DEFAULT NULL,
  `use_documents` tinyint(1) DEFAULT NULL,
  `affiliate_pricing` tinyint(1) DEFAULT '1',
  `auto_confirm` tinyint(1) DEFAULT '1',
  `capacity` int DEFAULT '1',
  `min_quantity` int DEFAULT '1',
  `max_quantity` int DEFAULT NULL,
  `ext_booking_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `instant_booking` tinyint(1) DEFAULT '0',
  `guest_only` tinyint(1) DEFAULT '0',
  `admin_rating` int DEFAULT '0',
  `restaurant` tinyint(1) DEFAULT '0',
  `restaurant_price` int DEFAULT '0',
  `ext_booking_url_direct` tinyint(1) DEFAULT '0',
  `pdf_file_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pdf_content_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pdf_file_size` int DEFAULT NULL,
  `pdf_updated_at` datetime DEFAULT NULL,
  `embed_document` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `musement_widget_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hide_price` tinyint(1) DEFAULT '0',
  `fareharbor_company_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fareharbor_item_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fareharbor_updated_at` datetime DEFAULT NULL,
  `description_from_provider` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `description_closing` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `show_min_quantity` tinyint(1) DEFAULT '1',
  `show_max_quantity` tinyint(1) DEFAULT '1',
  `name_on_reservation` tinyint(1) DEFAULT NULL,
  `slot_15min_increment` tinyint(1) DEFAULT NULL,
  `fixed_units` float DEFAULT NULL,
  `gift_card` tinyint(1) DEFAULT '0',
  `visitor_price_cents` int DEFAULT NULL,
  `visitor_price_currency` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `index_listings_on_fareharbor_company_id` (`fareharbor_company_id`),
  KEY `index_listings_on_fareharbor_item_id` (`fareharbor_item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=555853 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1159220 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=19014 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=803456 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=616185 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_methods` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `cb_customer_id` varchar(255) DEFAULT NULL,
  `auto_collection` tinyint(1) DEFAULT NULL,
  `payment_type` varchar(255) DEFAULT NULL,
  `reference_id` varchar(255) DEFAULT NULL,
  `card_last4` varchar(255) DEFAULT NULL,
  `card_type` varchar(255) DEFAULT NULL,
  `status` varchar(255) DEFAULT NULL,
  `event_last_modified_at` datetime DEFAULT NULL,
  `subscription_id` bigint DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_payment_methods_on_subscription_id` (`subscription_id`),
  CONSTRAINT `fk_rails_f828b36835` FOREIGN KEY (`subscription_id`) REFERENCES `subscriptions` (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=61928 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=250180 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `paypal_payments` (
  ...
  `paypal_refund_transaction_id` varchar(255) DEFAULT NULL,
  `refund_total_cents` int DEFAULT NULL,
  `refund_fee_total_cents` int DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=17483 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `paypal_soap_accounts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paypal_soap_accounts` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `person_id` varchar(22) DEFAULT NULL,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_paypal_soap_accounts_on_person_id` (`person_id`)
...
CREATE TABLE `people` (
  ...
  `sort_priority` int DEFAULT '3',
  `website_url` varchar(255) DEFAULT NULL,
  `membership_status` int NOT NULL DEFAULT '0',
  `membership_expires_at` date DEFAULT NULL,
  `referral_id` varchar(255) DEFAULT NULL,
  `referrer_id` varchar(255) DEFAULT NULL,
  `signup_charge_id` varchar(255) DEFAULT NULL,
  `is_affiliate` tinyint(1) DEFAULT '0',
  `is_hotel` tinyint(1) DEFAULT '0',
  `notes` varchar(255) DEFAULT NULL,
  `hotel_id` varchar(255) DEFAULT NULL,
  `booking_start` varchar(255) DEFAULT NULL,
  `booking_end` varchar(255) DEFAULT NULL,
  `booking_date` varchar(255) DEFAULT NULL,
  `referral_address` varchar(255) DEFAULT NULL,
  `tripadvisor_location_id` varchar(255) DEFAULT NULL,
  `chargebee_id` varchar(255) DEFAULT NULL,
  `event_last_modified_at` datetime DEFAULT NULL,
  `chargebee_data` text,
  `chargebee_hosted_page_id` varchar(255) DEFAULT NULL,
  `cb_item_id` bigint DEFAULT NULL,
  `signup_plan_id` bigint DEFAULT NULL,
  `customer_message_under_book` varchar(255) DEFAULT NULL,
  `pdf_file_name` varchar(255) DEFAULT NULL,
  `pdf_content_type` varchar(255) DEFAULT NULL,
  `pdf_file_size` int DEFAULT NULL,
  `pdf_updated_at` datetime DEFAULT NULL,
  `embed_document` varchar(1024) DEFAULT NULL,
  `embed_document_button_color` varchar(255) DEFAULT NULL,
  `fareharbor` tinyint(1) DEFAULT '0',
  `person_white_label_id` bigint DEFAULT NULL,
  `name_on_reservation` varchar(255) DEFAULT NULL,
  `reviews_disabled` tinyint(1) DEFAULT '0',
  `hotel_guest` tinyint(1) DEFAULT '0',
  `guest_type_pricing_enabled` tinyint(1) NOT NULL DEFAULT '0',
  ...
  KEY `index_people_on_cb_item_id` (`cb_item_id`),
  KEY `index_people_on_signup_plan_id` (`signup_plan_id`),
  KEY `index_people_on_person_white_label_id` (`person_white_label_id`),
  KEY `index_people_on_guest_type_pricing_enabled` (`guest_type_pricing_enabled`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `person_fareharbors`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `person_fareharbors` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `person_id` varchar(22) DEFAULT NULL,
  `fareharbor_shortname` varchar(255) DEFAULT NULL,
  `fareharbor_items` int DEFAULT NULL,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_person_fareharbors_on_person_id` (`person_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5079 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `person_white_labels`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `person_white_labels` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `person_id` varchar(255) DEFAULT NULL,
  `logo_file_name` varchar(255) DEFAULT NULL,
  `logo_content_type` varchar(255) DEFAULT NULL,
  ...
  `custom_color1` varchar(255) DEFAULT NULL,
  `custom_color2` varchar(255) DEFAULT NULL,
  `slogan_color` varchar(255) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `index_person_white_labels_on_person_id` (`person_id`)
...
CREATE TABLE `reviews` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_reviews_on_community_id` (`community_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=10904 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `signup_plans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `signup_plans` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `code` varchar(255) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  ...
  `active` tinyint(1) DEFAULT '0',
  `position` int DEFAULT '0',
  `signup_group_id` bigint DEFAULT NULL,
  `signup_button_text` varchar(255) DEFAULT NULL,
  `create_account_button_text` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_signup_plans_on_signup_group_id` (`signup_group_id`)
...
CREATE TABLE `stripe_accounts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1671 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `subscriptions` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_subscriptions_on_plan_id` (`plan_id`),
  KEY `index_subscriptions_on_person_id` (`person_id`),
  CONSTRAINT `fk_rails_63d3df128b` FOREIGN KEY (`plan_id`) REFERENCES `plans` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=62673 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transaction_add_ons` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_transaction_add_ons_on_tx_id` (`tx_id`)
...
CREATE TABLE `transaction_fields` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_transaction_fields_on_transaction_id` (`transaction_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=37735 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=375550 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactions` (
  ...
  `referral_id` varchar(255) DEFAULT NULL,
  `referral_discount` int DEFAULT NULL,
  `person_white_label_id` bigint DEFAULT NULL,
  `tax_percent` varchar(255) DEFAULT NULL,
  `tax_cents` int DEFAULT NULL,
  `service_fee_percent` varchar(255) DEFAULT NULL,
  `service_fee_cents` int DEFAULT NULL,
  `listing_price_cents` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `index_transactions_on_person_white_label_id` (`person_white_label_id`)
) ENGINE=InnoDB AUTO_INCREMENT=268911 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `tripadvisor_responses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tripadvisor_responses` (
  `id` bigint NOT NULL AUTO_INCREMENT,
