...
#  deleted                                    :boolean
#  affiliate_percent                          :float(24)        default(10.0)
#  membership_extend                          :integer          default(3)
#  hotel_percent_platform                     :float(24)        default(10.0)
#  hotel_percent_user                         :float(24)        default(5.0)
#  referral_discount                          :integer          default(0)
#  hotel_percent_guest                        :float(24)        default(5.0)
#  platform_percent_guest                     :float(24)        default(10.0)
#  self_service_price_cents                   :integer
#  premium_for_everyone                       :boolean
#
# Indexes
#
...
class Community < ApplicationRecord
  ...
  monetize :self_service_price_cents, :allow_nil => true, :with_model_currency => :currency
