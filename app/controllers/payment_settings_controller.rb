class PaymentSettingsController < ApplicationController
  ...
  def index
    ...
    @paypal_soap_account = paypal_soap_account
  ...
  def update_paypal
    paypal_soap_account.update(paypal_soap_account_params)

    return redirect_to person_payment_settings_path
  end
  ...
  def paypal_index
    paypal_account = paypal_soap_account
    community_country_code = LocalizationUtils.valid_country_code(@current_community.country)
  ...
  def paypal_soap_account
    current_person.paypal_soap_account || current_person.build_paypal_soap_account
  end

  def paypal_soap_account_params
    params.require(:paypal_soap_account).permit(
      :login,
      :password,
      :signature,
    )
