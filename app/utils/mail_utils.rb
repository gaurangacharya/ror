module MailUtils
  ...
  def set_up_layout_variables(recipient, community, ref="email", transaction = nil)
    @community = community
    @current_community = community
    @url_params = {}
    if white_label_domain = transaction&.person_white_label&.full_domain
      @url_params[:host] = white_label_domain
    else
  ...
  def community_specific_sender(community, transaction = nil)
    if email_sender = transaction&.person_white_label&.email_sender
