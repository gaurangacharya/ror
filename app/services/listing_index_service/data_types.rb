module ListingIndexService::DataTypes
  ...
  SearchParams = EntityUtils.define_builder(
    ...
    [:affiliate, :array, :optional],
    [:affiliate_pricing, :to_integer, :optional],
    [:instant_booking, :to_integer, :optional],
    [:guest_only, :to_integer, :optional],
    [:referral_id, :string, :optional],
    [:force_sphinx, :to_bool, :optional],
  )
  ...
  Listing = EntityUtils.define_builder(
    ...
    [:hide_price, :to_bool, :optional],
    [:icon_name, :optional],
    [:restaurant, :to_bool, :optional],
    [:restaurant_price, :string, :optional],
    [:ext_booking_url, :string, :optional],
    [:ext_booking_url_direct, :to_bool, :optional],
  )
