  ...
  def listing_hash(l, includes, meta={})
    {
      ...
      icon_name: l.author.is_affiliate? ? 'affiliate' : nil,
      restaurant: l.restaurant,
      restaurant_price: l.restaurant_price,
      ext_booking_url: l.ext_booking_url,
      ext_booking_url_direct: l.ext_booking_url_direct,
    }.merge(meta)
