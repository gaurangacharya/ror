...
class RobotsGenerator
  ...
  def self.index_content(req)
    [
      # robots.txt for OwnOutdoors.com
      # Purpose: Block aggressive bots that overload server resources
      # Date: September 2025
      ...
      # ===== BLOCK SEO/ANALYSIS BOTS =====
      # These create unnecessary load without business value
      ...
      # ===== DEFAULT RULES =====
      # All other bots: restricted access
      "User-agent: *",
      "Disallow: /*auth$",
      "Disallow: /s",
      "Disallow: /en/s",
