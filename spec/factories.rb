...
FactoryBot.define do
  ...
  factory :custom_field, aliases: [:question] do
    ...
    factory :custom_dropdown_field, class: 'DropdownField' do
      ...
      has_many :options do |custom_field|
        [FactoryBot.build(:custom_field_option), FactoryGirl.build(:custom_field_option)]
      end
    end
  ...
  factory :listing_image do
    ...
    width { 640 }
    height { 480 }
    author { listing.author if listing }
  end
end
