...
const SEARCH_PARAMS_TO_KEEP = new RegExp('^(view|locale|affiliate|checkbox_filter|checkbox_filter|filter_option|price_max|price_min|vendor|sort_order)');
...
const profileActions = function profileActions(routes, username) {
  return username ?
  {
    ...
    listingsAction: routes.person_settings_path(username),
...
class Topbar extends Component {
  render() {
    ...
    const signupRoute = this.props.signUpPath ? this.props.signUpPath : (this.props.routes.sign_up_path ? this.props.routes.sign_up_path() : '#');
    const showLoginLinks = this.props.showLoginLinks;
