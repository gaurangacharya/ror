Rails.application.routes.draw do
  ...
  post "/logfp" => "fingerprints#create"
  ...
  get '/:locale/:username/s' => 'homepage#index', as: :white_label_search, constraints: ->(request) do
    locale_matcher_anchored.match(request.params["locale"]) &&
    Person.exists?(username: request.params["username"])
  end
  ...
  get '/docusign_connect' => 'admin/docusign_templates#connect', as: :admin_docusign_connect
  ...
  scope "(/:locale)", :constraints => { :locale => locale_matcher } do
    ...
    get '/rf/:referral_id' => 'homepage#set_referral', as: :set_referral
    ...
    resource :chargebee, only: [:new] do
      member do
        post :create_person
        get :checkout
        post :checkout_new
    ...
    namespace :admin do
      ...
      resources :docusign_templates

      resources :premium_members, only: [:index]
      resources :reviews
    ...
    resources :listings do
      ...
      resources :working_time_slots, controller: 'listings/working_time_slots'
      resources :booked_time_slots, controller: 'listings/booked_time_slots'
      resources :availability_dates, controller: 'listings/availability_dates'
    end
    ...
    devise_scope :person do
      ...
      resources :people, param: :username, :path => "", :only => :show, :constraints => { :username => /[_a-z0-9\-]{3,100}/ }
      ...
      resources :people, except: [:show] do
        collection do
          ...
          get :check_referral_id
          get :check_referral_coupon
          get :check_coupon
          resources :signup_groups, only: [:show]
        end
      end
      ...
      resources :people, except: [:show], :path => "" do
        ...
        resources :transactions, only: [:show, :new, :create, :edit] do
          member do
            post :refund
            post :preauth_deposit
            post :cancel_and_refund
        ...
        resource :settings do
          member do
            ...
            get :subscriptions, action: :chargebee_subscriptions
          end
        end
