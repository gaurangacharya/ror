# Fix for Ruby 3.2+ compatibility - define URI methods before registering adapters
module URI
  def self.escape(url)
...
# Monkey patch HttpUrlProxyAdapter to handle URI.unescape properly
module Paperclip
  class HttpUrlProxyAdapter < UriAdapter
    def initialize(target, options = {})
      ...
      # Fallback if URI.unescape fails
      super(URI(escaped), options)
    end
  end
end
